      ...
      <Layout>
        <div className="flex-container">
          ...
          <div>
            ...
            <button to="process" role="link" onClick={() => this.scrollToElement()} className="arrow-link">Learn My Process<FontAwesomeIcon className="down-arrow" icon="long-arrow-alt-down" /></button>
          </div>
        </div>
      </Layout>
    </section>
